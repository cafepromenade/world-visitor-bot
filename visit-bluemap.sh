...
echo "=========================================="
echo "  World Visitor + BlueMap Live"
echo "  Bots: ${BOT_COUNT}"
echo "=========================================="
echo ""
...
echo "[1/3] Starting Minecraft server + ${BOT_COUNT} bot(s) + BlueMap (web mode)..."
echo "       BlueMap web UI: http://localhost:8100"
echo ""

case "$BOT_COUNT" in
  1) SERVICES="mc visitor bluemap" ;;
  2) SERVICES="mc visitor visitor1 bluemap" ; PROFILE="--profile multi" ;;
  3) SERVICES="mc visitor visitor1 visitor2 bluemap" ; PROFILE="--profile multi" ;;
  4) SERVICES="mc visitor visitor1 visitor2 visitor3 bluemap" ; PROFILE="--profile multi" ;;
esac
...
echo "Done. You can serve the map with: docker compose -f compose.bluemap.yml up"
